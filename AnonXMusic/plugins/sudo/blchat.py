...
@app.on_message(filters.command(["/blchet","blchat","/blacklistchat","بلوك","بلاك ليست"], "") & SUDOERS)
@language
...
@app.on_message(
    filters.command(["whitelistchat","/whitelistchat","/unblacklistchat","unblacklistchat", "unblchat","/unblchat","الغاء البلوك"],"") & SUDOERS
)
@language
...
@app.on_message(filters.command(["blchats","/blchats","blacklistedchats","/blacklistedchats","قائمة البلوك","القائمه السوداء","قائمة البلوكات","قائمه البلوك","قائمه البلوكات"],"") & ~BANNED_USERS)
@language
